...
#sudo mount -t nfs -o nolock,intr,soft,vers=3,timeo=10,retrans=10,actimeo=10,retry=5 storagegateway-staging.internal.lib.virginia.edu:/lib-content-21 $DEST_DIR
res=$?
